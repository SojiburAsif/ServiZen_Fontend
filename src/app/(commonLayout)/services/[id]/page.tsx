  ...
  return (
    <div className="min-h-screen bg-[#050505] text-white selection:bg-emerald-500/30">
      ...
      <div className="relative mx-auto max-w-7xl px-4 py-8 sm:px-6 lg:px-8">
        <Link
          href="/services"
          className="group mb-8 inline-flex items-center gap-2 text-sm font-medium text-zinc-400 hover:text-emerald-400 transition-colors"
        >
        ...
        <div className="grid gap-12 lg:grid-cols-12 lg:items-start">
          <div className="lg:col-span-7 space-y-6">
            <div className="relative aspect-[16/10] overflow-hidden rounded-3xl border border-zinc-800 bg-zinc-900 shadow-2xl">
              <img
            ...
            <div className="grid grid-cols-3 gap-4">
              {[
                ...
                <div key={i} className="rounded-2xl border border-zinc-800 bg-zinc-900/50 p-4 text-center">
                  <item.icon className="mx-auto h-5 w-5 text-emerald-500 mb-2" />
                  <p className="text-sm font-semibold block">{item.label}</p>
                  <p className="text-[10px] uppercase tracking-wider text-zinc-500 font-semibold">{item.sub}</p>
                </div>
              ))}
            </div>
          </div>
          ...
          <div className="lg:col-span-5 space-y-8">
            <div className="space-y-4">
              ...
              <h1 className="text-4xl font-semibold tracking-tight sm:text-5xl lg:text-6xl text-white">
                {service.name}
              </h1>
            ...
            <div className="group flex items-center gap-4 p-5 rounded-2xl bg-zinc-900 border border-zinc-800 transition-colors hover:border-emerald-500/30">
              ...
              <div className="flex-1">
                <div className="flex items-center gap-1">
                  <h4 className="font-semibold text-zinc-200">{service.provider?.name}</h4>
                  <ShieldCheck className="h-3.5 w-3.5 text-emerald-500" />
                </div>
                <p className="text-xs text-zinc-500">{service.provider?.contactNumber}</p>
              </div>
            </div>

            <div className="space-y-6 rounded-3xl border border-zinc-800 bg-zinc-900/80 p-8 backdrop-blur-xl">
              <div>
                <p className="text-xs font-semibold uppercase text-zinc-500 tracking-widest mb-1">Service Fee</p>
