    ...
    <main className="min-h-screen bg-white dark:bg-black text-zinc-900 dark:text-zinc-100">
      <div className="mx-auto w-full px-4 py-8 sm:px-6 lg:px-8">
        ...
        <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
          {[...Array(6)].map((_, i) => (
            <div key={i} className="rounded-3xl border border-zinc-200 dark:border-zinc-800 bg-white dark:bg-zinc-950 shadow-sm overflow-hidden">
              <div className="pb-4 pt-6 px-6 bg-zinc-50/50 dark:bg-zinc-900/50 border-b border-zinc-100 dark:border-zinc-800">
              ...
              <div className="p-6 space-y-4">
                ...
                <div className="flex items-center justify-between pt-4 border-t border-zinc-100 dark:border-zinc-800">
                  <Skeleton className="h-3 w-24 bg-zinc-100 dark:bg-zinc-900" />
                  <Skeleton className="h-5 w-20 bg-zinc-100 dark:bg-zinc-900" />
                </div>
              </div>
            </div>
          ))}
